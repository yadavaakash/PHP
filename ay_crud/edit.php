...
<html>
    <body>
        <form method="post" enctype="multipart/form-data">
            ...
            <br>
            Address : <textarea name="address" cols="30" rows="10"><?php echo $row['st_address']?></textarea>
            <br>
            Gender : <input type="radio" name="txt2"  value = "<?php echo $row['st_gender']; ?>" />Male
                     <input type="radio" name="txt2"  value = "<?php echo $row['st_gender']; ?>" />Female
            <br> 
