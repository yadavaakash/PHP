<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $queryeid = mysqli_query($connection, "update tbl_student set st_fname='{$fname}', st_lname='{$lname}', st_number='{$number}', st_email='{$email}', st_password='{$password}', st_gender='{$gender}', st_hobbies='{$hobbies}', st_photo='{$photo}'  where st_id = '{$eid}' ");
...
<html>
    <body>
        <form method="post" enctype="multipart/form-data">
            ...
            <br>
            Mobile No : <input type="number" name="number" value="<?php echo $row['st_number'] ?>">
            <br>
            ...
            <br>
            Eddress : <textarea name="address" cols="20" rows="6"><?php echo $row['st_address'] ?></textarea>
            <br>
